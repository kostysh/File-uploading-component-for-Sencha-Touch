 ...
 * +---------------+------------+------------+---------+
 *
 * RMQ+-1 requires the 1st order difference of the data to be either +1 or -1.
 * Linear RMQ is baes on the Cartesian tree expansion of the data.
 *
 * Ref: http://en.wikipedia.org/wiki/Range_Minimum_Query, http://wcipeg.com/wiki/RMQ
 */
