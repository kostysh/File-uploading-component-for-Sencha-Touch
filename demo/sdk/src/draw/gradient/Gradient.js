...
Ext.define("Ext.draw.gradient.Gradient", {
    ...
    getGradient: function (ctx, bbox) {
        return Ext.draw.gradient.Gradient.gradientCache.get(this.id + ',' + bbox.x + ',' + bbox.y + ',' + bbox.width + ',' + bbox.height, this, ctx, bbox);
    },
     ...
     */
    clearCache: function () {
        Ext.draw.gradient.Gradient.gradientCache.clear();
    }
